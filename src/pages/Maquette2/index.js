  ...
  return (
    <>
        ...
        <nav className="navbar">
            <img src={`/images/maquette2/Logo.png`} className="logo" alt="logo"/>
            <ul className="links">
        ...
        <header style={{ backgroundImage: `url(${process.env.PUBLIC_URL + '/images/maquette2/bakground.jpg'})`}}>
                    ...
                    <div className="gauche">           
                        <div className="gallerie">
                            <div className="artiste">
                                <img className="artiste-image" src={`/images/maquette2/image1.jpg`} alt="image"/>
                            </div>
                            <div className="artiste">
                                <img className="artiste-image" src={`/images/maquette2/image3.jpg`} alt="image"/>
                            </div>
                            <div className="artiste">
                                <img className="artiste-image" src={`/images/maquette2/image2.jpg`} alt="image"/>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="bas">
                    <div className="liste">
                        <div className="guitare">
                            <img className="affiche" src={`/images/maquette2/guitar1.jpg`} alt="image"/>
                            <div className="infos">
                                <div>
                        ...
                        <div className="guitare">
                            <img className="affiche" src={`/images/maquette2/guitar2.jpg`} alt="image"/>
                            <div className="infos">
                                <div>
                        ...
                        <div className="guitare">
                            <img className="affiche" src={`/images/maquette2/guitar3.jpg`} alt="image"/>
                            <div className="infos">
                                <div>
                        ...
                        <div className="guitare">
                            <img className="affiche" src={`/images/maquette2/guitar4.jpg`} alt="image"/>
                            <div className="infos">
                                <div>
